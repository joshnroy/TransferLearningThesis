...
class DataSequence(Sequence):
    def __init__(self):
        self.filenames = glob.glob("vae_pendulum_data/*.npz")
        self.image_size = 32
        self.i = 0
        self.batch_size = 100
        self.npz_idx = 0
...
x_decoder = Conv2DTranspose(filters=6, kernel_size=1, strides=1, activation='relu', padding='same')(x_decoder)
...
# Load Data
        data = np.load(glob.glob("vae_pendulum_data/*.npz")[0])
